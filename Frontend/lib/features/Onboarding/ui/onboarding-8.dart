...
import 'package:mindbloom/features/Onboarding/ui/onboarding-7.dart';
            ...
            children: [
              Column(
                children: [
                  ...
                  _buildHobbyButton("Single"),
                  SizedBox(
                    height: screenHeight * 0.01,
                  ),
                  _buildHobbyButton("In a relationship"),
                  SizedBox(
                    height: screenHeight * 0.01,
                  ),
                  _buildHobbyButton("Married"),
                  SizedBox(
                    height: screenHeight * 0.01,
                  ),
                  _buildHobbyButton("Divorced"),
                  SizedBox(
                    height: screenHeight * 0.01,
                  ),
                  _buildHobbyButton("Widowed"),
                  SizedBox(
                    height: screenHeight * 0.01,
                  ),
                  _buildHobbyButton("Other"),
                ],
              ),
              Column(
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => OnboardingEight(),
                          ));
                        },
                        child: Padding(
