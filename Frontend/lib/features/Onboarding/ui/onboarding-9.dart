...
import 'package:mindbloom/features/Onboarding/ui/onboarding-8.dart';

class OnboardingNine extends StatefulWidget {
  const OnboardingNine({super.key});
            ...
            children: [
              Column(
                children: [
                  ...
                  _buildHobbyButton("Yes"),
                  SizedBox(
                    height: screenHeight * 0.01,
                  ),
                  _buildHobbyButton("No"),
                  SizedBox(
                    height: screenHeight * 0.01,
                  ),
                ],
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => OnboardingNine(),
                          ));
                        },
                        child: Padding(
